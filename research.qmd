...
<div class="page-header">
  <div class="eyebrow">Research at DigiPols</div>
  <h1 style="font-size: clamp(2.4rem, 5vw, 3.6rem); line-height: 1.02; letter-spacing: -0.03em; font-weight: 500; max-width: 22ch; margin: 0;">Four clusters organised around digital politics.</h1>
  <p class="lede">DigiPols research is organised around four clusters that bring together social scientists and computer scientists working on complementary areas. Each is coordinated through the DigiPols Forum.</p>
</div>
```
